...
public class NPCCarLv1 : MonoBehaviour
{
    ...
    [Header("Pathfinding")]
    public TrafficNodeLv1 currentNode;
    ...
    {
        NPCStopLineLv1 stopLine = other.GetComponent<NPCStopLineLv1>();
        if (stopLine != null)
        {
            if (stopLine.stopType == NPCStopLineLv1.StopType.TrafficLight)
                StartCoroutine(TrafficLightRoutine(stopLine));
            else if (stopLine.stopType == NPCStopLineLv1.StopType.StopSign)
                StartCoroutine(StopSignRoutine(stopLine));
        }
    }

    IEnumerator TrafficLightRoutine(NPCStopLineLv1 stopLine)
    {
    ...
    IEnumerator StopSignRoutine(NPCStopLineLv1 stopLine)
    {
        isStoppedByTraffic = true;
