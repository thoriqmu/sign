...
public class NPCCarLv3 : MonoBehaviour
{
    ...
    [Header("Pathfinding")]
    public TrafficNodeLv3 currentNode;
    ...
    {
        NPCStopLineLv3 stopLine = other.GetComponent<NPCStopLineLv3>();
        if (stopLine != null)
        {
            if (stopLine.stopType == NPCStopLineLv3.StopType.TrafficLight)
                StartCoroutine(TrafficLightRoutine(stopLine));
            else if (stopLine.stopType == NPCStopLineLv3.StopType.StopSign)
                StartCoroutine(StopSignRoutine(stopLine));
        }
    }

    IEnumerator TrafficLightRoutine(NPCStopLineLv3 stopLine)
    {
    ...
    IEnumerator StopSignRoutine(NPCStopLineLv3 stopLine)
    {
        isStoppedByTraffic = true;
